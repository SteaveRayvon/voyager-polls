...
Vue.component('poll', __webpack_require__(44));
Vue.component('poll-question', __webpack_require__(43));
Vue.component('poll-creator', __webpack_require__(42));
...
var slugify = __webpack_require__(39);
	...
	methods: {
		newQuestion: function newQuestion() {
			return {
				id: '',
				question: '',
				answers: [{ 'id': '', 'answer': '', 'correct': '0' }, { 'id': '', 'answer': '', 'correct': '0' }, { 'id': '', 'answer': '', 'correct': '0' }],
				correct: 0
			};
		},
...
module.exports = {
	...
	methods: {
		newAnswer: function newAnswer() {
			...
			this.question.answers.push({ id: '', answer: '', correct: 0 });
			this.$nextTick(function () {
...
module.exports = {
	...
	props: ['slug', 'poll', 'prefix', 'type', 'correct_answer'],
		...
		createEmptyPoll: function createEmptyPoll() {
			this.poll = {
				questions: {
					...
					correct_answer: '',
					correct: '',
					answers: [{ 'id': '', 'answer': '', 'correct': [] }, { 'id': '', 'answer': '', 'correct': [] }, { 'id': '', 'answer': '', 'correct': [] }],
					answered: false
				}
			};
		}
	...
	created: function created() {
		...
		if (__webpack_require__.i({"NODE_ENV":"development"}).MIX_ROUTE_PREFIX) {
			this.routePrefix = '/' + __webpack_require__.i({"NODE_ENV":"development"}).MIX_ROUTE_PREFIX;
		} else {
			if (this.prefix) {
...
Component.options.__file = "A:\\PHPShtormProject\\video-conversation\\vendor\\voyager-polls\\resources\\assets\\js\\poll-creator.vue"
...
Component.options.__file = "A:\\PHPShtormProject\\video-conversation\\vendor\\voyager-polls\\resources\\assets\\js\\poll-question.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
Component.options.__file = "A:\\PHPShtormProject\\video-conversation\\vendor\\voyager-polls\\resources\\assets\\js\\poll.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
  ...
  return _c('div', {
    ...
    on: {
      "click": function($event) {
        return _vm.$emit('delete-question')
      }
    }
  }, [_vm._v("\n\t\t\tRemove Question\n\t\t\t"), _c('i', {
    ...
    return _c('div', {
      ...
      on: {
        "keyup": function($event) {
          ...
          return _vm.newAnswerEnter(id)
        },
        "input": function($event) {
          if ($event.target.composing) { return; }
          _vm.$set(_vm.question.answers[id], "answer", $event.target.value)
        }
      }
    }), _vm._v(" "), _c('i', {
      staticClass: "voyager-trash",
      on: {
        "click": function($event) {
          return _vm.deleteAnswer(id)
        }
      }
    }), _vm._v(" "), _c('div', {
      staticClass: "radio text-left"
    }, [_c('label', {
      ...
      directives: [{
        name: "model",
        rawName: "v-model",
        value: (_vm.question.answers[id].correct),
        expression: "question.answers[id].correct"
      }],
      attrs: {
        "type": "radio",
        "name": "correct",
      ...
      domProps: {
        "value": _vm.question.answers[id].id,
        "checked": _vm._q(_vm.question.answers[id].correct, _vm.question.answers[id].id)
      },
      on: {
        "change": function($event) {
          return _vm.$set(_vm.question.answers[id], "correct", _vm.question.answers[id].id)
        }
      }
    }), _vm._v(" Правильный вариант\n                                ")])])])])
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "poll-container",
    attrs: {
      "data-sticky-container": ""
    }
  }, [(_vm.loaded) ? _c('div', {
    staticClass: "poll-loaded"
  }, [_c('div', {
    directives: [{
      name: "show",
      rawName: "v-show",
    ...
    staticClass: "panel panel-default poll-panel d-none",
    attrs: {
      "data-margin-top": "80"
    }
  }, [_c('div', {
    ...
    return _c('div', {
      ...
      return _c('div', {
        ...
        class: [question.answered == answer.id ? 'answer-container question-answer' : 'answer-container']
      }, [(answer) ? _c('label', [_c('input', {
        attrs: {
          "type": "radio",
          "name": answer.id,
          "disabled": (typeof(question.answered) != 'undefined' && question.answered != '') ? true : false
        },
        domProps: {
          "checked": question.answered == answer.id
        },
        on: {
          "click": function($event) {
            return _vm.vote(answer, question)
          }
        }
      }), _vm._v("\n\t\t\t\t\t\t\t\t\t\t" + _vm._s(answer.answer))]) : _c('label', [_c('input', {
        attrs: {
          "type": "radio",
          "name": "answer"
        }
        ...
        staticClass: "poll-percentage-bar"
      }, [_c('div', {
        staticClass: "percentage-mask"
      }), _vm._v(" "), _c('span', {
        style: ({
          width: answer.vote_percentage + '%'
        })
      })]), _vm._v(" "), _c('p', [_vm._v(_vm._s(answer.vote_percentage) + "%")])]) : _vm._e()])])
    })], 2)
  }), 0)])]), _vm._v(" "), _c('div', {
    ...
    attrs: {
      "id": "next",
      "disabled": ((this.current_index < this.poll.questions.length && this.poll.questions[this.current_index - 1].answered) || _vm.isPreview) ? false : true
    },
    on: {
      "click": _vm.next
    }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.$set(_vm.poll, "slug", $event.target.value)
      }
    }
  })]), _vm._v(" "), _c('div', {
    staticClass: "col-md-6"
  ...
  }, [_c('label', [_vm._v("Выбор")]), _vm._v(" "), _c('select', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.poll.type),
    ...
    on: {
      "change": function($event) {
        ...
        _vm.$set(_vm.poll, "type", $event.target.multiple ? $$selectedVal : $$selectedVal[0])
      }
    }
  }, [_c('option', {
    attrs: {
    ...
    domProps: {
      "selected": [_vm.poll.type == 'radio' ? 'selected' : '']
    }
  }, [_vm._v("Одиночный")]), _vm._v(" "), _c('option', {
    attrs: {
      "value": "checkbox"
    },
    domProps: {
      "selected": [_vm.poll.type == 'checkbox' ? 'selected' : '']
    }
  }, [_vm._v("Множественный")]), _vm._v(" "), _c('option', {
    attrs: {
      "value": "variant"
    },
    domProps: {
      "selected": [_vm.poll.type == 'variant' ? 'selected' : '']
    }
  }, [_vm._v("Одиночный с правильным вариантом")]), _vm._v(" "), _c('option', {
    attrs: {
      "value": "one_answer"
    },
    domProps: {
      "selected": [_vm.poll.type == 'one_answer' ? 'selected' : '']
    }
  }, [_vm._v("Со своим вариантом ответа")])]), _vm._v(" "), _c('br'), _c('br'), _vm._v(" "), _c('div', {
    staticClass: "d-none",
    attrs: {
      "id": "correct_answer"
    }
  }, [_c('label', [_vm._v("Количество первых правильных")]), _vm._v(" "), _c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.poll.correct_answer),
      expression: "poll.correct_answer"
    }],
    staticClass: "form-control",
    attrs: {
      "name": "correct_answer",
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.$set(_vm.poll, "correct_answer", $event.target.value)
      }
    }
  })])]), _vm._v(" "), _c('div', {
    staticClass: "col-md-6"
